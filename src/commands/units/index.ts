...
export const unitsCommand = new Command('units').alias('unit').description('Unit type commands');
...
const getCommand = new Command('get')
  ...
  .action(
    withErrorHandling(async (id: UnitTypeId) => {
...
const updateCommand = new Command('update')
  ...
  .action(
    withErrorHandling(async (id: UnitTypeId, options) => {
