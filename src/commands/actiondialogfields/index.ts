...
const createCommand = new Command('create')
  ...
  .action(withErrorHandling(async (options) => {
    ...
    const result = await coreCreateActionDialogField(client, { config: config as Record<string, unknown> });
...
const updateCommand = new Command('update')
  ...
  .action(withErrorHandling(async (id: number, options) => {
    ...
    const result = await coreUpdateActionDialogField(client, { id, config: config as Record<string, unknown> });
