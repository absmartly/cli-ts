...
export const listCommand = new Command('list')
  ...
  .option('--unit-types <values>', 'filter by unit type names or IDs (comma-separated)')
  .option('--owners <values>', 'filter by owner names, emails, or IDs (comma-separated)')
  .option('--teams <values>', 'filter by team names or IDs (comma-separated)')
  .option('--tags <values>', 'filter by tag names or IDs (comma-separated)')
